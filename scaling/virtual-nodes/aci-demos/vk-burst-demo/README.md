...
```
$ helm install stable/kube-lego --name kube-lego --namespace kube-system --set config.LEGO_EMAIL=karabasosman@hotmail.com,config.LEGO_URL=https://acme-v01.api.letsencrypt.org/directory
```
